...
import { ArrowRight, Bone, Heart, Activity, Monitor, Wind, Snowflake, Dumbbell, Tooth, Tablet, Flask, Home, Scissors, Shield, Baby, Ambulance } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, i) => (
            <motion.div
              ...
              className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl transition-all duration-300 group border border-transparent hover:border-secondary/20"
            >
